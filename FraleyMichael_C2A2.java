...
public class FraleyMichael_C2A2 {
    ...
    public static void displayDataOnScreen(int userNumberOfRooms, double totalWallSpace, double priceOfPaintPerGallon,
                                            double gallonsOfPaintRequired, double hoursOfLaborRequired, double costOfPaint,
                                            double laborCharges, double totalCost){
    String.format("User number of rooms: %d\nTotal wall space: %.2f\nPrice of per gallon: %,.2f\nGallons of paint" +
            "required: %.1f\nHours of labor required: %.1f\nCost of paint: $%,.2f\nLabor Charges: $%,.2f" +
            "\nTotal Cost: $%,.2f",userNumberOfRooms,totalWallSpace,priceOfPaintPerGallon, gallonsOfPaintRequired,
